...
par(mar=c(3,3,3,3))
plot(dta$Date, dta$rmg, type='l', lwd=2, xlab='', ylab='Iterest-growth differential' ) #, main='Interest-growth differential' )
...
par(mfrow=c(2,1))
plot(dta$Date, dta$ngdp_pch, type='l', lwd=2, main='Nominal GDP', xlab='', ylab='' )
abline(h=us.mu.est[1], col='blue', lwd=1, lty=1 )
...
lines( dta$Date[which(dta$Date == "2010-01-01")+1:n.pred-1], pred.2010[1,] - var.sd[1,], lwd=1, col='red', lty=2 )
plot(dta$Date, dta$rfr4, type='l', lwd=2, main='Nominal interest rate', xlab='', ylab='' )
abline(h=us.mu.est[2], col='blue', lwd=1, lty=1 )
...
plot(dta$Date, dta$rfr4 - dta$ngdp_pch, type='l', lwd=2, main='R minus G', xlab='', ylab='' )
abline(h=diff(us.mu.est), col='blue', lwd=1, lty=1 )
abline(h=0, lwd=.5)
