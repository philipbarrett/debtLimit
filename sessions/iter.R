...
e.grid <- e_grid_fn(params$surp.sd, 13, params$d.tri )
...
d_prime( 0, sol.w$d[1] - 10, sol.w$d, 1 / params$R[1], Q, d.grid, params$G, params$lambda,
         e.grid, params$v.s.coeff, params$tri, matrix(0), FALSE, print_level=1 )
...
q.e <- q_e( d.grid[13], sol.w$d, 1 / params$R, Q, d.grid, params$G, params$lambda,
            e.grid, params$v.s.coeff, params$tri, matrix(0), FALSE, params$trans, print_level=2 )
